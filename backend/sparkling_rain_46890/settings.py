"""
Django settings for sparkling_rain_46890 project.
...
ROOT_URLCONF = 'sparkling_rain_46890.urls'
...
WSGI_APPLICATION = 'sparkling_rain_46890.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sparkling_rain_46890 API",
    "DESCRIPTION": "API documentation for sparkling_rain_46890 App",
    "VERSION": "v1",
}
